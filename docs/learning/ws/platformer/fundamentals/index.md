---
layout: learning/index
title: "Accueil : Platformer - Les bases"
permalink: /learning/ws/platformer/fundamentals/
---
...
<div class="container home" >
	...
	<div class="row" >
		<div class="col-sm-6" >
			<p class="lead" >
				<a href="{{ site.url }}/learning/ws/platformer/fundamentals/fr/introduction/" role="button" class="btn btn-secondary" >Commencer</a>
			</p>
		</div>
		<div class="col-sm-6" >
			<p class="lead" >
				<a href="{{ site.url }}/learning/ws/platformer/fundamentals/en/introduction/" role="button" class="btn btn-secondary" >Start</a>
			</p>
		</div>
	</div>
</div>
